...
public class TextWidget extends Widget {
    ...
    public TextWidget(int x, int y, int w, String defaultText) {
        super(x, y, w, 0);
    ...
    public void render(GuiGraphicsExtractor gui, int mx, int my) {
        ...
        this.h = lines.size() * 13 + 2 * PADDING;

        DrawUtil.drawRectOutline(x - PADDING, y - PADDING, w + 2 * PADDING, h, PADDING, -1);
        gui.fill(x, y, x + w, y + h - 2 * PADDING, isHovered(mx, my) ? BG_COLOR.brighter().getRGB() : BG_COLOR.getRGB());
